...
DS4A_Img = html.Div(children=[html.Img(src=app.get_asset_url("Logo.jpg"),id="ds4a-image",style={ 'width':'85%','position':'absolute', 'display': 'flex','flex': 1,'textAlign': 'center', 'color': '#7FDBFF'},)],)
...
sidebar = html.Div(
    [
        ...
        html.Br(),  # Add an horizontal line
        html.Br(),
        html.Hr(),
        ####################################################
