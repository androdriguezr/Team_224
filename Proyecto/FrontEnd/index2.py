...
app.layout = html.Div(
    [
        ...
        html.Hr(),
        html.Div(className="Principal",children=[dbc.Row(dbc.Col(html.H5("Seleccione el modulo de interes"), style={'textAlign': 'center'},width={"size": 6, "offset": 3}))]),
        html.Hr(),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        dbc.Button("INGRESAR AL MODELO", id="btnmodelo", n_clicks=0,style={'position':'center', 'display': 'flex','flex': 1,"horizontalAlign": "middle",'textAlign': 'center',"verticalAlign": "center"}),
        html.Br(),
        html.Br(),
